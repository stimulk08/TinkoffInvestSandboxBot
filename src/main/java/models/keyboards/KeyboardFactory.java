...
public class KeyboardFactory {
	...
	public static InlineKeyboardMarkup makeInlineKeyboard(
			List<List<InlineButtonInfo>> keyboardInfo) {
	...
	private static List<List<InlineKeyboardButton>> getInlineKeyboardRows(
			List<List<InlineButtonInfo>> keyboardInfo) {
